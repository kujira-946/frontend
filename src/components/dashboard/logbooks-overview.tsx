...
const UserSummary = styled.section`
  display: flex;
...
export const LogbooksOverview = () => {
  ...
  const { selectedLogbookId, logbookTotalSpent, totalSpent, remainingBudget } =
      ...
      <UserSummary>
        ...
        <UserInformation>
          ...
          <LogbooksOverviewUserInfoCell
            ...
            cost={`$${Functions.formattedNumber(
              Number(remainingBudget.value)
            )}`}
            inputError={false}
          />
        </UserInformation>
