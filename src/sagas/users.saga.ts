...
function* fetchUser(action: IdAction) {
  try {
    ...
    console.log(error);
    yield Saga.put(Redux.errorsActions.setUser("Failed to fetch user."));
  }
}
...
function* updateUser(action: IdAction) {
  try {
    ...
    console.log(error);
    yield Saga.put(Redux.errorsActions.setUser("Failed to update user."));
  }
}
...
function* deleteUser(action: IdAction) {
  try {
    ...
    console.log(error);
    yield Saga.put(Redux.errorsActions.setUser("Failed to delete user."));
  }
}
