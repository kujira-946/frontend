...
export const onboardingCopies: Copy[] = [
  {
    ...
    bodyTexts: [
      "In a nutshell, this app was created to help you manage your financial health. In order to help you with that, however, you’re going to have to fill in some important information in the following steps with as much accuracy as possible. Please do not round any values.",
      "Rest assured, all information is private to you and will never be shared with anyone else. With that said, let’s do some setup, starting with your take-home income!",
    ],
